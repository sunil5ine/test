...
(function() {
    ...
    root.options.networks = root.options.networks.toLowerCase().split(',');
		...
		***********************************************/
		...
		if (!root.button) {
			root.button = document.createElement('div');
    ...
    root.button.addEventListener('click', function(event) {
		...
		var iconClass = root.options.iconStyle == 'default' ? 'need-share-button_link fab need-share-button_' : 'need-share-button_link-' + root.options.iconStyle + ' need-share-button_link fab need-share-button_';
