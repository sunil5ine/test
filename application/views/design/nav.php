...
<div class="page">
  <div id="spinner">
    <div class="spinner-img"> <img alt="Opportunities Preloader" src="<?php echo $this->config->base_url();?>web/images/common/loader.gif" />
      <h2>Please Wait.....</h2>
    </div>
  </div>
  ...
  <nav id="menu-1" class="mega-menu fa-change-black" data-color="">
    <section class="menu-list-items container">
      <div class="container">
        <ul class="menu-logo">
             <li> <a href="#"> <img src="<?php echo $this->config->base_url();?>web/images/common/logo.png" alt="logo" class="img-responsive"> </a> </li>
        ...
        <ul class="menu-links pull-left">
          ...
          <li class="mobile-show"> <a href="<?php echo $this->config->base_url().'PostCV';?>"> Register </a></li>
        </ul>
        <ul class="startup-links pull-right mobile-hide" style="margin-left:0px !important">
          ...
          <li class="no-bg"><a href="<?php echo $this->config->base_url().'hire/login';?>" class="p-job"><i class="fa fa-plus-square"></i> Employer Zone</a></li>
        </ul>
      </div>
    </section>
  </nav>
