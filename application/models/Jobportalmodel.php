...
class Jobportalmodel extends CI_Model {
    ...
    public function get_record($jtitle=null,$shrt=null,$funarea=null,$location=null,$jtype=null,$sal=null,$expr=null)
    {
    	...
    	$this->db->select('job_url_id, job_updated_dt, hire_status, job_title, job_location, job_min_exp as minexp, job_max_exp as maxexp, job_min_sal, job_max_sal, job_industry, job_farea, job_role, job_edu, job_edu_spec, job_skills, job_company, job_desc, job_type, job_created_dt, job_created_by, jfun_display ');
    	...
    	// $this->db->join ( 'ch_jobpost',        'ch_jobpost.job_id = ch_jobs.job_id' , 'right' );
