                                ...
                                <div class="x_content">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <tbody>
                                                  ...
                                                  <tr class="<?php echo $tdcls; ?>">
                                                    ...
                                                    <td><?php echo '<strong>Plan</strong> : '.$result->pr_name.' <br> <strong>Validity period</strong> : '.$result->pr_limit.' month(s) <br> <strong>No of jobs</strong> : '.$result->pr_nojob;?></td>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-5">
                                                ...
                                                <!-- <button type="submit" class="btn btn-success"  tabindex="16">payment</button> -->
                                                <div id="paypal-button"><a href="<?php echo base_url('Subscription/buy');?>"><img src="<?php echo base_url()?>images/bye.png" style="max-width: 100%;width: 150px"></a></div>
