                                    ...
                                    <table class="table table-striped responsive-utilities jambo_table">
										...
										?>
                                            ...
                                            <tr class="<?php echo $tdcls; ?>">
                                                ...
                                                <td class=" "><?php echo '<strong>Plan</strong> : '.$result->pr_name.' <br> <strong>Validity period</strong> : '.$result->pr_limit.' month(s) <br> <strong>No of jobs</strong> : '.$result->pr_nojob;?></td>
