...
#skill_dummy, #jrole_dummy, #industry_dummy{
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
										<div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                <input type="text" class="form-control has-feedback-left" id="hcompany" name="hcompany" placeholder="Hiring For" value="Hiring For :- Self" readonly="readonly">
    ...
    <script type="text/javascript" src="<?php echo $this->config->item('web_url');?>js/jobs.js"></script>
