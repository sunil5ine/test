	...
	<div class="right_col" role="main">
    	<div class="">
                    ...
                    <div class="row">
						<form class="form-horizontal form-label-left input_mask" action="<?php echo base_url('psychotest/processcart'); ?>" method="post">
                                ...
                                <div class="x_content">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <tbody>
                                                  ...
                                                  <tr class="even pointer">
                                                    ...
                                                    <td><i class="fa fa-usd "></i> <?php echo $result->psyr_amount;?></td>
                                                  </tr>                                                  
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="paypal-button">
                                                <a href="<?php echo base_url('Psychotest/buy?name=').$name.'&amt='.$sumamt?>"><img src="<?php echo base_url()?>images/bye.png" style="max-width: 100%;width: 150px"></a>
                                            </div>
