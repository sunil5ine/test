							...
							<div class="collection-item">
								<div class="row mb0">
									<div class="col m12 s12 l10">
										...
										<p class="small-text m0"><span class="font12 bold">Location:</span> <?php echo $result->job_location ?></p>
										<ul class="saved-jobs-list">
						        			...
						        			<li>
												...
												<span class="font12"><?php echo $result->minexp;?> ~  <?php echo $result->maxexp;?></span>
						        			</li>
										</ul>
									</div>
