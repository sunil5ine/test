...
class Jobsmodel extends CI_Model {
...

	{
		...
		j.job_notes, 
		j.job_status, 
		e.deg_type_display as edu_name, 
		f.jfun_display as fun_name, 
		miexp.exp_display as minexp,
		maexp.exp_display as maxexp, 
		emp.emp_comp_name, 
		emp.emp_fname, 
		emp.emp_jobportal, 
		emp.emp_desc, 
		...
		from ".$this->table_job." j left join ".$this->table_edu." e on e.deg_type_id = j.job_edu left join 
		".$this->table_farea." f on f.jfun_id = j.job_farea left join ".$this->table_exp." 
		miexp on miexp.exp_id = j.job_min_exp left join ".$this->table_exp." 
		maexp on maexp.exp_id = j.job_max_exp left join ".$this->table_emp." 
		emp on emp.emp_id = j.job_created_by where j.job_url_id='".$jid."'");
