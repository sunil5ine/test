                  ...
                  <div class="col m12 s12 l9">
                     <div class="row">
                        <div class="col s12 m6 l7">
                           ...
                           <h6 class="m0 bold"> <small><i>Hello, Admin. Add new employer package!</i></small> </h6>
                        </div>                        
                     </div>

                     <div class="card">
                        <div class="card-content">
                           <form action="<?php echo base_url('pricing/add-emp-package') ?>" method="post" style="overflow:visible">
                             ...
                             <div class="row m0">
                                ...
                                <div class="input-field col s12 l4">
                                    <input type="number" id="number" required name="jobs" class="validate" value="">
                                    <label for="number" data-error="wrong" data-success="right">Premium Job</label>
                                </div>
                                <div class="input-field col s12 l4">
                                    <input type="number" id="number" required name="vcan" class="validate" value="">
