 ...
 <div class="col l3 m12 s12">
   ...
   <div class="side-bar white z-depth-1">
      <ul class="li-list ">
        ...
        <li class="<?php echo($this->uri->segment(1) == 'partners-enquiry' )?'active' :'' ?>"><a href="<?php echo base_url('partners-enquiry') ?>"><i class="fas  li-icon fa-handshake"></i>Partners enquiry</a></li>
