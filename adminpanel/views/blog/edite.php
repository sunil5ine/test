                ...
                <div class="col l12 m12 s12">
                    <div class="row">
                        ...
                        <div class="col m12 s12 l9">
                            <div class="row">
                                <div class="col 12 m6">
                                    <p class="h5-para black-text m0">Edite Blog</p>
                                </div>
                                <div class="col 12 m6 right-align">
                                    <a href="<?php echo base_url('blog/lists') ?>" class="waves-effect waves-light btn green darken-4 white-text hoverable ">Cancel </a>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-content">
                                    <div class="form-container">
                                        <form enctype="multipart/form-data" action="<?php echo base_url() ?>blog/update" method="post" style="overflow-y: auto;overflow-x: hidden;">
                                        
                                          <div class="row m0">
                                              <div class="input-field col s12 l6">
                                                <i class="far fa-calendar-alt prefix"></i>
                                                <input type="text" id="pdate" name="postdate" value="<?php echo date('M d, Y',strtotime($blog['postOn']))?>" class="validate datepicker">
                                                <label for="pdate">Schedule date (Optional)</label>
                                              </div>
                                              <div class="input-field col s12 l6">
                                                <input type="text" id="blog-title" value="<?php echo $blog['title'] ?>" name="title" class="validate" required>
                                            ...
                                            <div class="row m0">
                                              <div class="input-field col s12 l6">
                                                <input type="text" id="seoTitle" name="stitle" value="<?php echo $blog['metatitle'] ?>" class="validate" required>
                                                <label for="seoTitle">SEO Title <span class="red-text">*</span></label>
                                              </div>
                                              <div class="input-field col s12 l6">
                                                <input type="text" id="seoDes" name="sdes" class="validate"  value="<?php echo $blog['metades'] ?>" required>
                                            ...
                                            <div class="row ">
                                                <div class="input-field col s12 l6">
                                                  <input type="text" id="skey" name="skeyword" class="validate" value="<?php echo $blog['metakey'] ?>" required>
                                            ...
                                            <div class="col s12">
                                                ...
                                                <input type="hidden" value="<?php echo $blog['file'] ?>" name="fileName">
                                                <input type="hidden" value="<?php echo $blog['id'] ?>" name="blogId">
                                                <input type="hidden" value="<?php echo $blog['file_origin'] ?>" name="fileOrigin">
                                            </div>
