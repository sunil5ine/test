                  ...
                  <div class="col m12 s12 l9">
                     <div class="row">
                        <div class="col s12 m6 l7">
                           <p class="h5-para black-text  m0">Update Testimonial</p>
                           ...
                           <div class="row">
                             <div class="card">
                                  <div class="card-content">
                                      <form action="<?php echo base_url() ?>testimonial/update" method="post" enctype='multipart/form-data'>
                                        <div class="input-field col s12 l6">
                                          <input type="text" id="first_name" name="name" value="<?php echo  $testimonial['ts_name'] ?>"  required class="validate">
                                          <label for="first_name">Name <span class="red-text">*</span></label>
                                        </div>
                                        <div class="input-field col s12 l6">
                                          <input type="text" id="last_name" value="<?php echo  $testimonial['ts_desg'] ?>" name="des" class="validate" required>
                                          <label for="last_name">Designation <span class="red-text">*</span></label>
                                        </div>
                                        
                                        <div class="input-field col s12">
                                          <textarea id="textarea1 " name="content" class="materialize-textarea validate" required><?php echo  trim($testimonial['ts_content']) ?></textarea>
                                          <label for="textarea1">Content <span class="red-text">*</span></label>
                                        </div>
                                        <input type="hidden" name="id" value="<?php echo  $testimonial['ts_id'] ?>">
