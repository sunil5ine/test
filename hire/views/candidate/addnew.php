	...
	<div class="right_col" role="main">
    	<div class="">
                    ...
                    <div class="row">
						<form class="form-horizontal form-label-left input_mask" action="<?php echo base_url(); ?>Candidate/Add" method="post" data-toggle="validator" role="form" enctype="multipart/form-data">
                                ...
                                <div class="x_content">
                                    <br />
                                    	<div class="col-md-6 col-sm-6 form-group has-feedback">
                                            <?php echo form_dropdown('jobname',$job_list,$formdata['jobname'],'id="jobname" class=" form-control has-feedback-left" tabindex="1" required');?>
