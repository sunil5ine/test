                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                   	 	Thanks for suscribing with us, now you are able to publish jobs. Enjoy!
                                    </div>
                                    <?php  } else { ?>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
										<?php if($transaction['trans_status'] == 1 && $transaction['trans_pay_respcode']==100){?> 
                                        	<a title="Edit" href="<?php echo $this->config->base_url().'MyJobs'; ?>"><button type="button" class="btn btn-primary pull-right">Post Jobs!</button></a>
										<?php } else { ?>
                                        	<a title="Edit" href="<?php echo $this->config->base_url().'Subscriptions'; ?>"><button class="btn btn-success pull-right" type="submit">Try Again</button></a>
