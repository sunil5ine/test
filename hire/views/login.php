                ...
                <div class="signup-main">
                    <div class="col-lg-12">
                        ...
                        <div class="content-header text-center">
                            <h1>Find the <strong>RIGHT candidate</strong>!</h1>
                    ...
                    <div class="col-lg-6 lform">
                        ...
                        <div class="clearfix"> </div>
                        <form method="post" name="signinfrm" action="<?php echo $this->config->base_url();?>Login/" data-toggle="validator" role="form" class="login_box_new">
                            ...
                            <div class="col-md-12 space-top-12">
                                <div class="col-md-5 space-top-12">
                                    <a href="<?php echo $this->config->item('web_url').'PostJob';?>" class="reset_pass">New Signup</a>
                                </div>
