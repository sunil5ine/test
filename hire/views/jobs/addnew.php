...
#skill_dummy, #jrole_dummy, #industry_dummy {
	...
	<div class="right_col" role="main">
    	<div class="">
                    ...
                    <div class="row">
                        <form name="jobfrm" id="jobfrm" action="<?php echo base_url(); ?>Jobs/Add" method="post">
                                    ...
                                    <br />										
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                 <input type="text" tabindex="1" class="form-control has-feedback-left" id="jtitle" name="jtitle" placeholder="Job Title - ex: Sr PHP Developer with 2Yr exp" value="<?php echo $formdata['jtitle']; ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                <!-- <input type="text" tabindex="2" class="form-control  has-feedback-left" id="location" name="location" placeholder="Job Location" value="<?php //echo $formdata['location']; ?>"> -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
                                                <?php echo form_dropdown('minexp',$minexp_list,$formdata['minexp'],'id="minexp" class=" form-control has-feedback-left" tabindex="4" ');?>
                                                <span class="fa fa-clock-o form-control-feedback left" aria-hidden="true"></span>
                                                <span id="minexp_validate"></span>
                                            </div>
                                            <div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
                                                <?php echo form_dropdown('maxexp',$maxexp_list,$formdata['maxexp'],'id="maxexp" class=" form-control has-feedback-left" tabindex="5" ');?>
                                                <span class="fa fa-clock-o form-control-feedback left" aria-hidden="true"></span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                <?php echo form_dropdown('farea',$funarea_list,$formdata['farea'],'id="farea" class=" form-control has-feedback-left" tabindex="8" ');?>
                                                <span class="fa fa-windows form-control-feedback left" aria-hidden="true"></span>
                                                <span id="farea_validate"></span>
                                            </div>
                                            
                                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                <?php echo form_dropdown('edu',$edu_list,$formdata['edu'],'id="edu" class=" form-control has-feedback-left" tabindex="9" ');?>
                                        ...
                                        <!-- <div class="form-group">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <label><i class="fa fa-tags"></i> Skills:</label> 
                                                 <?php //echo form_dropdown('skill[]',$skill_list,$formdata['skill'],'id="skill" class="anyone select2_multiple form-control" multiple="multiple" tabindex="12" ');?>
                                                <span id="skill_validate"></span>
                                            </div>
                                        </div>   -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                ...
                                                <input id="skillval" type="text" class="tags" name="skillval" value="<?php echo $formdata['skillval']; ?>" >
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
										 <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                <input type="text" class="form-control has-feedback-left" id="hcompany" name="hcompany" placeholder="Hiring For" value="<?php echo $this->session->userdata('hirename'); ?>">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                Please do not enter any contact email, phone or URL in the description to avoid job beign rejected by the Job portals!
                            </div>
