                ...
                <div class="signup-main">
                    <div class="col-lg-12">
                        <div class="content-header text-center">
                            <h1>Find the <strong>RIGHT Candidate</strong>. Login and update your Profile!</h1>
                        ...
                        <form method="post" name="resetfrm" id="resetfrm" action="<?php echo $this->config->base_url();?>User/ConfirmReset/?process=go" class="login_box_new">
                            ...
                            <div class="col-md-12 space-top-12">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input data-toggle="tooltip" type="password" class="form-control" placeholder="Enter New Password" value="" name="npwd" id="npwd" required>
                                </div>
                            </div>
                            <div class="col-md-12 space-top-12">
...
<script type="text/javascript">
  $('#npwd').tooltip({'trigger':'focus', 'placement':'bottom', 'html':'true', 'title': '<b>Password must contain:</b> <br > Atleast 8 characters.'});
