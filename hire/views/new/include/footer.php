						...
						<div class="row">
							...
							<div class="col s6 m4 l4">
								<div class="footer-container">
									...
									<div class="footer-content">
										<ul>
											<li><a href="<?php echo base_url()?>login">Get a free account</a></li>
											<li><a href="<?php echo base_url()?>Jobs/Add">Post  jobs</a></li>
								...
								<div class="footer-container">
									...
									<div class="footer-content">
										...
										<li><a href="<?php echo $this->config->item('web_url') ?>Jobs?jobs=list">Find Jobs</a></li>
											<li><a href="<?php echo $this->config->item('web_url') ?>CV_Writing">Professional CV Writing</a></li>
											<li><a href="<?php echo $this->config->item('web_url') ?>Psychometric">Psychometric Test</a></li>
										</ul>
									</div>
								</div>
							</div>
				...
				<div class="bottom-footer container-wrap">
					...
					<div class="col s12 m6 l6 ">
						<ul class="footernav">
							...
							<li>|</li>
							<li><a href="<?php echo $this->config->item('web_url') ?>Terms">Terms of use</a></li>
							<li>|</li>
							<li>Sitemap</li>
						</ul>
					</div>
