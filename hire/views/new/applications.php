				...
				<div class="col m12  s12 l9 pofile-details-table-card">
					...
					<div class="row">	
						<div class="appl-job-heading col m8 s8 l12 ">
							<p class="black-text h5">All Applications</p>
                            <small><i>Applied candidates lists</i></small>
                        </div>
                    </div>
                        <div class="row">
                            <ul class="collection with-header">
                                ...
                                <?php } }else{ ?>
                                    ...
                                    <li class="collection-item cv-lists ptb15">
                                            <div class="block">
                                                <center>
                                                    <img src="<?php echo $this->config->item('web_url') ?>assets/img/empty.png" class="responsive-img ">
                                                    <p class="h5 typography">Oops... There are no applicationd Found</p>
                                                </center>
                                            </div>
                                     </li>
